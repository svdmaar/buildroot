...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_AVS_ENABLE_THUNDER_INPUT_MANAGER),y)
WPEFRAMEWORK_AVS_CONF_OPTS += -DPLUGIN_AVS_ENABLE_THUNDER_INPUT_MANAGER=ON
else
WPEFRAMEWORK_AVS_CONF_OPTS += -DPLUGIN_AVS_ENABLE_THUNDER_INPUT_MANAGER=OFF
endif
...
ifeq ($(BR2_PACKAGE_WPEFRAMEWORK_AVS_ENABLE_A4B),y)
WPEFRAMEWORK_AVS_CONF_OPTS += -DPLUGIN_AVS_ENABLE_A4B=ON
else
WPEFRAMEWORK_AVS_CONF_OPTS += -DPLUGIN_AVS_ENABLE_A4B=OFF
endif
